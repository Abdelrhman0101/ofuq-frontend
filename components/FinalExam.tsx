...
const defaultExamQuestions: ExamQuestion[] = [
  {
    id: 1,
    question: "ما هي الركائز الأساسية التي يقوم عليها منهج معهد أفق التعليمي؟",
    options: [
  ...
  {
    id: 2,
    question: "كيف يحقق معهد أفق التوازن بين الأصالة والمعاصرة في برامجه التعليمية؟",
    options: [
  ...
  {
    id: 3,
    question: "ما هو الهدف من تطبيق مبادئ التربية الحديثة في معهد أفق؟",
    options: [
  ...
  {
    id: 4,
    question: "كيف تساهم التقنيات الحديثة في تحقيق رسالة معهد أفق التعليمية؟",
    options: [
  ...
  {
    id: 5,
    question: "ما دور الإعلام التربوي في فلسفة معهد أفق التعليمية؟",
    options: [
  ...
  {
    id: 6,
    question: "كيف يسد معهد أفق الفجوة بين التعليم النظري والممارسة العملية؟",
    options: [
  ...
  {
    id: 7,
    question: "ما أهمية الاستفادة من نخبة الخبراء والمتخصصين في معهد أفق؟",
    options: [
  ...
  {
    id: 8,
    question: "كيف تخدم البرامج الدبلومية في معهد أفق احتياجات سوق العمل؟",
    options: [
