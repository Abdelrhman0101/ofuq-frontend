...
const Quiz: React.FC<QuizProps> = ({ questions = defaultQuestions }) => {
  ...
  const handleFinish = () => {
    setIsFinished(true);
    // Here you can add logic to submit the quiz
    console.log('Quiz finished with answers:', selectedAnswers);
  };
