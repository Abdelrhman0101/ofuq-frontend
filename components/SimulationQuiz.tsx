...
const defaultSimulationQuestions: SimulationQuestion[] = [
  {
    id: 1,
    question: "ما هو الهدف الأساسي من دراسة العلوم الشرعية في معهد أفق؟",
    options: [
  ...
  {
    id: 2,
    question: "أي من التالي يُعتبر من أهم مبادئ التربية الحديثة التي يركز عليها معهد أفق؟",
    options: [
  ...
  {
    id: 3,
    question: "ما هي أهمية دمج التقنية في التعليم وفقاً لرؤية معهد أفق؟",
    options: [
  ...
  {
    id: 4,
    question: "كيف يساهم الإعلام التربوي في تحقيق أهداف معهد أفق؟",
    options: [
  ...
  {
    id: 5,
    question: "ما الذي يميز منهج معهد أفق في الجمع بين الأصالة والمعاصرة؟",
    options: [
