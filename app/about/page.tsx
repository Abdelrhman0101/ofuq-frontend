      ...
      <div className="about-container">
        ...
        <div className="hero-section content-section">
          <div className="hero-text">
            ...
            <p className="section-content">
              أفق منصة تعليمية رائدة متخصصة في بناء وتقديم برامج دبلوم احترافية في مجالات متنوعة تجمع بين الأصالة والمعاصرة. تأسست منصة أفق لسد الفجوة بين التعليم النظري والممارسة العملية من خلال مناهج علمية مبتكرة ومتكاملة تواكب احتياجات سوق العمل وتحديات العصر.
            </p>
            <p className="section-content">
              تتميز "أفق" بنهجها المتكامل الذي يجمع بين العلوم الشرعية والتربوية والتقنية والإعلامية، مما يمكنها من إعداد كوادر متخصصة قادرة على النهوض بمجتمعاتها وتحقيق التميز في مجالاتها. تعتمد منصة أفق على نخبة من الخبراء والمتخصصين في تصميم مناهجها وتقديم برامجها، مع الاستفادة من أحدث التقنيات والمنهجيات التعليمية العالمية.
            </p>
          </div>
       ...
       <div className="content-section">
          <div className="closing-box">
            ...
            <p className="section-content">
              من خلال هذه الهوية التعليمية المتكاملة، تسعى منصة أفق لأن تكون صرحًا تعليميا متميزًا يسهم في إعداد جيل من القادة المتخصصين القادرين على مواجهة تحديات العصر وتحقيق التنمية المستدامة لمجتمعاتهم.
            </p>
            <p className="section-content author">د. عبدالله أحمد الحجري</p>
          </div>
        </div>
      </div>
      <Footer />
